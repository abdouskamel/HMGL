...
class MyModel(nn.Module):
    def __init__(self, fts_dim, hid_dim, nb_relations, drop_prob=0.0, is_attn=False, common_gcn=False, normalize_z=False):
        super().__init__()
        ...
        if self.common_gcn:
            ...
            self.hier_layer = HierarchicalAggrLayer(hid_dim, hid_dim, nb_relations, 1, drop_prob, is_attn)

        else:
            self.hier_layer = HierarchicalAggrLayer(fts_dim, hid_dim, nb_relations, 1, drop_prob, is_attn)
